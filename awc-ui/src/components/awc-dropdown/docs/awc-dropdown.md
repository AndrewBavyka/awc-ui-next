...
| `position`     | `position`      |           | `AwcPopoverPosition` | "bottom-start" | Позиция отображения списка                       |
...
| `strategy`     | `strategy`      |           | `AwcPopoverStrategy` | "absolute"     | Стратегия позиционирования всплывающего окна.    |
